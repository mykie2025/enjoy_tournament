...
export async function GET() {
  try {
    // Make a request to our backend API for live matches
    const apiUrl = `${config.apiServer.baseUrl}/tournaments/api/live`;
    console.log(`Fetching live tournaments from: ${apiUrl}`);
